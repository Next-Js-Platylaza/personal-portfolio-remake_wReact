...
export default function WeatherComponent() {
	...
	const usingSavedData =
		weatherForecast.data == null || weatherForecast.data == undefined;

	const weatherData = usingSavedData
		? CrossPageData.weatherData ?? weatherForecast.data
	...
	if (usingSavedData) {
		...
		weatherForecast.location?.coords &&
		!weatherForecast.location?.loading
	) {
		locationText = "Local";
	}
